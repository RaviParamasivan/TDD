...
<div class="contact-opener">FEEDBACK</div>
    ...
    <div id="contact_body">
        ...
        <label for="subject"><span>Regarding</span>
			...
			<option value="Partnership">Product Availability</option>
            </select>
        </label>
...
<header id="header"><!--header-->
	...
	<div class="header_top"><!--header_top-->
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> info@jigarthanda.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
		...
		<div class="header-middle" style="background-color:#fe980f"><!--header-middle-->
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><span style="color:#fff; font-size:20px; font-weight:bold">JIGARTHANDA <span style="color:#333; font-size:20px; font-weight:bold">E CART</span></span></a>
						</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>JIGARTHANDA</span> E CART</h1>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Mobile Accessories</a></h4>
								</div>
							</div>
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2><span>JIGARTHANDA</span> E CART</h2>
					...
					<div class="col-sm-3">
						<div class="address">
							...
							<p>Address 1, Address 2, City, Country.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2013 JIGARTHANDA Inc. All rights reserved.</p>
				</div>
			</div>
		</div>
